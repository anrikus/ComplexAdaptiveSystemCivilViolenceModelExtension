...
globals [
  ...
  hardship-average
  hardship-average-social
  hardship-average-economic
  actual-hardship-average
  actual-hardship-social
  actual-hardship-economic
  no-of-arrests-per-tick
  no-of-cops
  government-legitimacy2
  grievance2
  rebellion-counter
]
...
agents-own [
  ...
  hardship-ratio      ; Ratio of hardship [Economic:Social] divison for an agent, fixed for life time
  perceived-hardship-social
  perceived-hardship-economic
  legitimacy
]
...
to setup
  ...
  set k 2.3
  set threshold 0.1
  set rebellion-counter 0.0
  ;;set hardship-average 0.0
  ...
  create-agents round (initial-agent-density * .01 * count patches) [
    ...
    set active? false
    set jail-term 0
    set hardship-ratio random-float 1.0
    set perceived-hardship-economic hardship-ratio * perceived-hardship
    set perceived-hardship-social ( 1 - hardship-ratio ) * perceived-hardship
    display-agent
  ]

  set hardship-average mean [ perceived-hardship ] of agents
  set hardship-average-social mean [ perceived-hardship-social ] of agents
  set hardship-average-economic  mean [ perceived-hardship-economic ] of agents
  set actual-hardship-economic mean [( 1 - economic-effectiveness ) * perceived-hardship-economic] of agents
  set actual-hardship-social mean [( 1 - social-effectiveness ) * perceived-hardship-social] of agents
  set actual-hardship-average mean [( 1 - economic-effectiveness ) * perceived-hardship-economic + ( 1 - social-effectiveness ) * perceived-hardship-social] of agents
  set no-of-cops count cops
...
to go
  ...
  set hardship-average-social mean [ perceived-hardship-social ] of agents
  set hardship-average-economic mean [ perceived-hardship-economic ] of agents
  set government-legitimacy2 ( 1 - ( (1 - alpha) * hardship-average + (1 - beta) * ( no-of-arrests-per-tick / no-of-cops ) ) / 2 )
  set actual-hardship-economic mean [( 1 - economic-effectiveness ) * perceived-hardship-economic] of agents
  set actual-hardship-social mean [( 1 - social-effectiveness ) * perceived-hardship-social] of agents
  set actual-hardship-average mean [( 1 - economic-effectiveness ) * perceived-hardship-economic + ( 1 - social-effectiveness ) * perceived-hardship-social] of agents
  if (grievance2 > government-legitimacy2)
  [set rebellion-counter rebellion-counter + 1]
  if (ticks >= max-number-of-ticks)
  [stop]
  tick
end
...
to-report grievance
  set grievance2 ( ( 1 - economic-effectiveness ) * perceived-hardship-economic + ( 1 - social-effectiveness ) * perceived-hardship-social ) * (1 - government-legitimacy2)
  report ( ( 1 - economic-effectiveness ) * perceived-hardship-economic + ( 1 - social-effectiveness ) * perceived-hardship-social ) * (1 - government-legitimacy2)
end
...
to enforce
  if any? (agents-on neighborhood) with [ active? ] [
    ...
    ask suspect [
      ...
      set no-of-arrests-per-tick no-of-arrests-per-tick + 1
    ]
  ]
end
...
"" ""
PENS
"Public Approval (Legitimacy)" 1.0 0 -13840069 true "" "plot government-legitimacy2"
"Experienced grievance" 1.0 0 -2674135 true "" "plot grievance2"
"pen-2" 1.0 0 -16777216 true "" "plot actual-hardship-average"
...
1080
303
Black Actual experienced hardship average
11
0.0
1
